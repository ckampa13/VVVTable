...
\end{tabular}
    \caption{Yields per bin for SR 1Lepton, including the VVV yield from cW at the $95$\% exclusion point. The limits on cW are: [$-0.103$,~$0.100$]. All Monte Carlo background yields have been combined, and the statistical uncertainties and symmetrized systematic uncertainties for the total background are added in quadrature. Yields are quoted for the full Run 2 dataset.}
